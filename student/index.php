...
$qprofile = mysqli_query($koneksi, "SELECT * FROM tbl_student WHERE username = '$_SESSION[username]'");
...
<head>
    ...
    <meta name="description" content="SMK Nusantara | Student">
    ...
    <title>SMK Nusantara - Student</title>
