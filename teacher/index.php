...
$qprofile = mysqli_query($koneksi, "SELECT * FROM tbl_teacher WHERE username = '$_SESSION[username]'");
$profile = mysqli_fetch_array($qprofile);


$qfoto = mysqli_query($koneksi, "SELECT * FROM tbl_user WHERE username = '$_SESSION[username]'");
$foto = mysqli_fetch_array($qfoto);
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <meta name="description" content="SMK Nusantara | Teacher">
    ...
    <title>SMK Nusantara - Teacher</title>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Teaching Schedule -->
            <li class="nav-item <?php
                                if ($menu == "schedule") {
                                    echo "active";
                                }
                                ?>">
                <a class="nav-link" href="?menu=schedule">
                    <i class="fas fa-fw fa-calendar"></i>
                    <span>Teaching Schedule</span></a>
            </li>
            ...
            <li class="nav-item <?php
                                ...
                                ?>">
                <a class="nav-link" href="?menu=score">
                    <i class="fas fa-fw fa-signal"></i>
                    <span>Input Score</span></a>
            </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <img class="img-profile rounded-circle" src="../uploads/<?= $foto['Photo']; ?>" alt="">
                            </a>
                ...
                <div class="container-fluid">
                    ...
                    switch ($menu) {
                        case 'schedule':
                            include "menu/schedule.php";
                            break;

                        case 'score':
                            include "menu/score.php";
                            break;
