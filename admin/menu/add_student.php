<?php
$result = mysqli_query($koneksi, "SELECT MAX(StudentID) as max_id FROM tbl_student WHERE StudentID LIKE 'STDN%'");
...
if ($max_id == '') {
    ...
    $angka_baru = $angka + 1;
    $id_baru = 'STDN' . sprintf('%04s', $angka_baru);
}
...
?>
        ...
        if ($User) {
            ...
            // insert student
            $q = "INSERT INTO tbl_student(StudentID, Username, Name, Address, Gender, DateOfBirth, PhoneNumber) VALUES('$id', '$id', '$name', '$address', '$jk', '$DTO', '$phone_number')";
