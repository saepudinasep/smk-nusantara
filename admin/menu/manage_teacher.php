...
<a href="?menu=add_teacher" class="btn btn-sm btn-primary mb-2">
    <span class="icon text-white-50">
        <i class="fas fa-plus-circle"></i>
    </span>
    Add Data
</a>
<a href="?menu=manage_teacher" class="btn btn-sm btn-secondary mb-2">
    <span class="icon text-white-50">
    ...
    <div class="col-lg-4 mb-4">
        ...
        <form>
            <div class="input-group">
                <input type="text" class="form-control border-primary small" placeholder="Search for..." aria-label="Search" aria-describedby="basic-addon2">
        ...
        <div class="table-responsive mb-4">
            <table class="table table-bordered text-center small" width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    if (isset($_POST['cari'])) {
                        if ($_POST['inputan'] == "") {
                            $q = mysqli_query($koneksi, "SELECT * FROM tbl_teacher limit $posisi, $batas");
                        } elseif ($_POST['inputan'] !== "") {
                            $q = mysqli_query($koneksi, "SELECT * FROM tbl_teacher WHERE Name LIKE '%$_POST[inputan]%' limit $posisi, $batas");
                        }
                    } else {
                        $q = mysqli_query($koneksi, "SELECT * FROM tbl_teacher limit $posisi, $batas");
                    }
            ...
            <ul class="pagination justify-content-center">
                ...
                ?>
                    <li class="page-item <?php if ($page == $i) {
                                                echo "active";
                                            } ?>"><a class="page-link" href="?menu=manage_teacher&hal=<?= $i; ?>"><?= $i; ?></a></li>
                <?php
                }
                ?>
            </ul>
...
<script>
    $(".delete").click(function() {
        Swal.fire({
            title: 'Are you sure?',
            text: "Semua yang berhubungan dengan teacher ini akan dihapus juga!",
            icon: 'warning',
